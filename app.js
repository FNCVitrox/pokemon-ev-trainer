...
const pveMoveSets = {
  ...
  11: ["Härtner", "Tackle", "Fadenschuss"],
  12: ["Psychokinese", "Schlafpuder", "Silberhauch", "Gigasauger"],
  13: ["Giftstachel", "Fadenschuss"],
  14: ["Härtner", "Giftstachel", "Fadenschuss"],
  15: ["Zwillingsnadel", "Durchbruch", "Schwerttanz", "Matschbombe"],
  ...
  20: ["Hyperzahn", "Rückkehr", "Schaufler", "Biss"],
  21: ["Schnabel", "Verfolgung", "Fliegen", "Rückkehr"],
  ...
  37: ["Flammenwurf", "Konfustrahl", "Schaufler", "Ruckzuckhieb"],
  38: ["Flammenwurf", "Konfustrahl", "Schaufler", "Rückkehr"],
  39: ["Gesang", "Rückkehr", "Doppelteam", "Schutzschild"],
  40: ["Rückkehr", "Donnerblitz", "Eisstrahl", "Gesang"],
  41: ["Flügelschlag", "Konfustrahl", "Biss", "Aero-Ass"],
  42: ["Flügelschlag", "Konfustrahl", "Biss", "Matschbombe"],
  43: ["Schlafpuder", "Säure", "Gigasauger", "Sonnentag"],
  44: ["Schlafpuder", "Säure", "Gigasauger", "Mondschein"],
  45: ["Gigasauger", "Schlafpuder", "Säure", "Mondschein"],
  46: ["Schlafpuder", "Schlitzer", "Gigasauger", "Pilzspore"],
  ...
  55: ["Surfer", "Psychokinese", "Eisstrahl", "Schaufler"],
  ...
  65: ["Psychokinese", "Gedankengut", "Genesung", "Donnerschlag"],
  66: ["Karateschlag", "Geowurf", "Fußkick", "Kreideschrei"],
  ...
  71: ["Rasierblatt", "Schlafpuder", "Säure", "Gigasauger"],
  72: ["Surfer", "Säure", "Konfustrahl", "Eisstrahl"],
  73: ["Surfer", "Eisstrahl", "Säure", "Barriere"],
  74: ["Steinwurf", "Schaufler", "Intensität", "Einrollen"],
  75: ["Steinhagel", "Schaufler", "Intensität", "Einrollen"],
  76: ["Erdbeben", "Steinhagel", "Durchbruch", "Explosion"],
  77: ["Flammenwurf", "Stampfer", "Schaufler", "Agilität"],
  78: ["Flammenwurf", "Stampfer", "Schaufler", "Rückkehr"],
  79: ["Surfer", "Konfusion", "Tagedieb", "Eisstrahl"],
  80: ["Surfer", "Psychokinese", "Eisstrahl", "Tagedieb"],
  81: ["Donnerblitz", "Donnerwelle", "Sternschauer", "Ultraschall"],
  82: ["Donnerblitz", "Donnerwelle", "Sternschauer", "Metallsound"],
  ...
  92: ["Psychokinese", "Hypnose", "Konfustrahl", "Nachtnebel"],
  93: ["Psychokinese", "Hypnose", "Konfustrahl", "Nachtnebel"],
  ...
  99: ["Surfer", "Krabbhammer", "Schutzschild", "Durchbruch"],
  ...
  111: ["Hornattacke", "Schaufler", "Steinwurf", "Stampfer"],
  ...
  119: ["Surfer", "Hornattacke", "Agilität", "Megahorn"],
  ...
  140: ["Surfer", "Steinhagel", "Schutzschild", "Schlitzer"],
  ...
  144: ["Eisstrahl", "Fliegen", "Lichtschild", "Agilität"],
  145: ["Donnerblitz", "Bohrschnabel", "Donnerwelle", "Lichtschild"],
  146: ["Flammenwurf", "Fliegen", "Feuerwirbel", "Agilität"],
  147: ["Drachenklaue", "Donnerwelle", "Surfer", "Sternschauer"],
  148: ["Drachenklaue", "Donnerwelle", "Surfer", "Sternschauer"],
  149: ["Drachentanz", "Erdbeben", "Fliegen", "Rückkehr"],
...
const extraMoveDescriptions = {
  de: {
    ...
    Konfustrahl: "verwirrt Gegner und gibt sichere freie Runden.",
    ...
    Schnabel: "frühe Flug-Attacke für Habitak.",
    ...
    Zwillingsnadel: "trifft zweimal und kann vergiften."
  },
  en: {
    ...
    Konfustrahl: "confuses the target and can create free turns.",
    ...
    Schnabel: "early Flying move for Spearow.",
    ...
    Zwillingsnadel: "hits twice and can poison."
  }
};
